...
namespace
{
    ...
    bool evaluateTestFrame()
    {
        ...
        // The D3D11 relay copies are flushed before this command list. Import
        // them as SRV resources for NGX and return ownership to COMMON after
        // the evaluation so the next frame can stage normally.
